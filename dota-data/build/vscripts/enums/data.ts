...
export const droppedConstants = [
  ...
  // Client-only animation/sound constants not available in VScript server API
  '__UNKNOWN__',
  '',
  ...
  'AE_EF_DRAW',
  'AE_EF_NODRAW',
  'muerta_debut_satyr_a',
  'muerta_debut_satyr_b',
  'muerta_debut_satyr_c',
];
...
export const prefixedEnums: Record<string, string | RegExp> = {
  ...
  DOTA_RuneStatus_t: 'DOTA_RUNE_STATUS_',
