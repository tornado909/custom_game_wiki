...
| IsBarrierFor( [DAMAGE_TYPES](https://iwasinminedream.github.io/moddota.github.io/api/#!/vscripts/DAMAGE_TYPES) ) | bool | Returns true if the damage type will be blocked by the barrier. |
| SetBarrierType( [DAMAGE_TYPES](https://iwasinminedream.github.io/moddota.github.io/api/#!/vscripts/DAMAGE_TYPES) ) | *nil* | Sets the barrier to block the specified type of damage. |
| GetBarrierType() | [DAMAGE_TYPES](https://iwasinminedream.github.io/moddota.github.io/api/#!/vscripts/DAMAGE_TYPES) | Returns what type of damage the barrier will block. |
...
Let's take the [Simple Example](https://iwasinminedream.github.io/moddota.github.io/abilities/lua-modifiers/5#simple-example) from earlier and remake it using the Library.
