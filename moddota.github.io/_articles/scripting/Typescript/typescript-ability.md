...
Before we start, I'm going to go ahead and link the [moddota tools](https://iwasinminedream.github.io/moddota.github.io/api/#!/vscripts), which feature the most up to date API for custom games in Dota 2. If you were using Valve's wiki, ditch it; it hasn't been updated in years.
...
1. Navigating to [moddota tools](https://iwasinminedream.github.io/moddota.github.io/api/#!/vscripts) and searching for the function, which shows the parameters:
